...
\subsubsection{Tela de carregamento} \label{tela_de_carregamento}
...
\newpage
\begin{lstlisting}[numbers=none,basicstyle=\small,caption={Tela de carregamento - XML}, title={Tela de carregamento - XML}, label={activity_splash.xml}]<?xml version="1.0" encoding="utf-8"?>
...
Após o carregamento dos dados na \nameref{tela_de_carregamento} o usuário é redirecionado para a tela principal, essa tela é responsável por criar vários fragmentos que levam o usuário para diferentes partes do aplicativo através de um menu de navegação inferior. Para melhorar a experiencia do usuário foi utilizado um \textit{view pager}, o que possibilita uma troca de conteúdo rápida de acordo com as ações do usuário. Por padrão a tela principal possui somente o menu de navegação inferior, o fragmento padrão é adicionado em tempo de execução, neste caso, usaremos o Fragmento Principal, que é responsável por mostrar o  principal.
...
basicstyle=\small,
caption={Tela Principal - Java},
title={Tela Principal - Java},
...
\newpage
\subsubsection{Fragmento Principal}
TESTE
\subsubsection{Tela de materiais}
\subsubsection{Tela de produtos}
\subsubsection{Tela de estatísticas}
