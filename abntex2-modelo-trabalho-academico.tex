...
No build.gradle, o campo dependencias nos permite baixar bibliotecas externas, adicionar arquivos jar ou módulos em nosso projeto Android. Neste projetos utilizaremos as dependencias abaixo.
\\
...
\newpage
 \begin{description}
   ...
   \item[Firebase] Persistência de dados
   \item[Glide] Carregamento de imagens
   \item[SmartTabLayout] Tablayout centralizado 
   \item[Gson] Converter JSON em POJO
   \item[YouTubeAndroidPlayerApi] Carregamento de vídeos
   \item[Fabric] Monitorar erros e estatísticas 
